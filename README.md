# Анализ алгоритмов; МГТУ; 5 семестр :white_check_mark:

## Лабораторные работы

- :one: Расстояние Левенштейшна, Дамерау-Левенштейна :heavy_check_mark:
- :two: Классический алгоритм перемножения матриц, алгоритм Винограда :heavy_check_mark:
- :three: Сортировка пузырьком, вставками, выбором :heavy_check_mark:
- :four: Многопоточная реализация алгоритма Винограда для п-я матриц :heavy_check_mark:
- :five: Многопоточный конвейер :heavy_check_mark:
- :six: Поиск крадчайшего пути при помощи муравьиного алгоритма :heavy_minus_sign:
- :seven: Поиск подстроки в строке. Алгоритм Кнута-Морриса-Пратта, Бойера-Мура :heavy_check_mark:
- :up: Фрактал: ковер Серпинского :heavy_check_mark:
- :up: Конечный автомат, регулярное выражение :heavy_check_mark:
